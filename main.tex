...
\setcounter{secnumdepth}{2} % No ".0" in the titles
...
\begin{document}
	...
	\begin{itemize}
		...
		\begin{figure}[H]
			...
			\begin{minipage}[t]{0.5\textwidth}
				\centering
				%	\fbox{\includegraphics[width=\textwidth]{img/chats.png}}
		...
		\begin{figure}[H]
			...
			\begin{minipage}[t]{0.5\textwidth}
				\centering
				%	\fbox{\includegraphics[width=\textwidth]{img/chat.png}}
		...
		\begin{figure}[H]
			...
			\begin{minipage}[t]{0.5\textwidth}
				\centering
				\fbox{\includegraphics[width=\textwidth]{img/profile.png}}
		...
		\begin{figure}[H]
			...
			\begin{minipage}[t]{0.32\textwidth}
				\centering
				\fbox{\includegraphics[width=\textwidth]{img/homework.png}}
				\caption*{Liste des devoirs}
			\end{minipage}
			\hfill
			\begin{minipage}[t]{0.32\textwidth}
				\centering
				\fbox{\includegraphics[width=\textwidth]{img/new_homework.png}}
				\caption*{Ajout d’un devoir}
			\end{minipage}
			\hfill
			\begin{minipage}[t]{0.32\textwidth}
				\centering
				\fbox{\includegraphics[width=\textwidth]{img/view_homework.png}}
